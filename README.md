...
**110 tools** across **16 categories**.  Full catalog with versions, images, and citations: [docs/reference/tools.md](docs/reference/tools.md).

| Category | # | Examples |
|---|--:|---|
| alignment | 6 | `bedtools`, `bowtie2`, `bwa`, `bwa_mem2`, … |
| assembly | 16 | `abyss`, `canu`, `flye`, `hifiasm`, … |
| assembly_qc | 6 | `busco`, `checkm2`, `compleasm`, `gfastats`, … |
