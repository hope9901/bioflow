...
**114 tools** across **16 categories**.  Full catalog with versions, images, and citations: [docs/reference/tools.md](docs/reference/tools.md).
...
| func_annot | 6 | `antismash`, `dbcan`, `eggnog_mapper`, `gtdbtk`, … |
