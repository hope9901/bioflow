...
**129 tools** across **16 categories**.  Full catalog with versions, images, and citations: [docs/reference/tools.md](docs/reference/tools.md).
...
| comparative_genomics | 14 | `abricate`, `cafe5`, `diamond`, `fastani`, … |
...
| metagenomics | 10 | `bracken`, `humann3`, `kneaddata`, `kraken2`, … |
| proteomics | 8 | `comet`, `fragpipe`, `maxquant`, `msconvert`, … |
| qc | 9 | `cutadapt`, `fastp`, `fastqc`, `filtlong`, … |
| repeat | 3 | `earlgrey`, `repeatmasker`, `repeatmodeler` |
| rnaseq_align | 8 | `hisat2`, `htseq`, `kallisto`, `rsem`, … |
| single_cell | 8 | `bustools`, `cellranger`, `harmony`, `monocle3`, … |
| struct_annot | 6 | `augustus`, `bakta`, `braker3`, `liftoff`, … |
| variant_calling | 8 | `bcftools`, `deepvariant`, `delly`, `ensembl_vep`, … |
