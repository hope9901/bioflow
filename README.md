...
**111 tools** across **16 categories**.  Full catalog with versions, images, and citations: [docs/reference/tools.md](docs/reference/tools.md).
...
| metagenomics | 8 | `bracken`, `humann3`, `kneaddata`, `kraken2`, … |
