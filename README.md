...
**137 tools** across **16 categories**.  Full catalog with versions, images, and citations: [docs/reference/tools.md](docs/reference/tools.md).

| Category | # | Examples |
|---|--:|---|
| alignment | 7 | `bedtools`, `bowtie2`, `bwa`, `bwa_mem2`, … |
...
| proteomics | 9 | `comet`, `fragpipe`, `maxquant`, `msconvert`, … |
| qc | 9 | `cutadapt`, `fastp`, `fastqc`, `filtlong`, … |
| repeat | 3 | `earlgrey`, `repeatmasker`, `repeatmodeler` |
| rnaseq_align | 8 | `hisat2`, `htseq`, `kallisto`, `rsem`, … |
| single_cell | 9 | `bustools`, `cellranger`, `harmony`, `kb_python`, … |
| struct_annot | 10 | `augustus`, `bakta`, `braker3`, `dfast`, … |
| variant_calling | 9 | `bcftools`, `deepvariant`, `delly`, `ensembl_vep`, … |
