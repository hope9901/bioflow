...
| `bowtie2` | 2.5.4 | `staphb/bowtie2:2.5.4` | Langmead & Salzberg 2012, PMID 22388286 | 43,609 | 25,504 |
| `bwa` | 0.7.18 | `quay.io/biocontainers/bwa:0.7.18--he4a0461_0` | Li & Durbin 2009, PMID 19451168 | 36,961 | 18,290 |
| `bwa_mem2` | 2.2.1 | `quay.io/biocontainers/bwa-mem2:2.2.1--he513fc3_0` | Vasimuddin 2019, PMID 31355760 | 7 | 7 |
...
| Tool | Version | Image | Citation | Total cites | Cites 2021–2025 |
|---|---|---|---|--:|--:|
| `abyss` | 2.3.7 | `quay.io/biocontainers/abyss:2.3.7--h103dbdd_4` | Jackman 2017, PMID 28298430 | 3,325 | 2,514 |
| `canu` | 2.2 | `quay.io/biocontainers/canu:2.2--ha47f30e_0` | Koren 2017, PMID 28298431 | 5,802 | 3,915 |
| `flye` | 2.9.5 | `quay.io/biocontainers/flye:2.9.5--py310h275bdba_2` | Kolmogorov 2019, PMID 31907358 | 0 | 0 |
| `hifiasm` | 0.19.9 | `quay.io/biocontainers/hifiasm:0.19.9--h43eeafb_0` | Cheng 2021, PMID 33526886 | 5,590 | 5,013 |
| `masurca` | 4.1.0 | `quay.io/biocontainers/masurca:4.1.0--pl5321hb5bd705_1` | Zimin 2017, PMID 28298434 | 1 | 1 |
...
| `nextdenovo` | 2.5.2 | `quay.io/biocontainers/nextdenovo:2.5.2--py311hc29ee83_7` | Hu 2024, PMID 38630727 | 2 | 2 |
| `nextpolish` | 1.4.1 | `quay.io/biocontainers/nextpolish:1.4.1--h3952c39_7` | Hu 2020, PMID 31504201 | 40 | 32 |
...
| `raven` | 1.8.1 | `quay.io/biocontainers/raven-assembler:1.8.1--h43eeafb_3` | Vaser & Sikic 2021, PMID 33526886 | 5,590 | 5,013 |
| `shasta` | 0.11.1 | `quay.io/biocontainers/shasta:0.11.1--h4ac6f70_2` | Shafin 2020, PMID 32514112 | 127 | 114 |
| `spades` | 4.0.0 | `staphb/spades:4.0.0` | Prjibelski 2020, PMID 32559359 | 2,441 | 2,197 |
| `unicycler` | 0.5.1 | `quay.io/biocontainers/unicycler:0.5.1--py312hdcc493e_5` | Wick 2017, PMID 28594827 | 6,754 | 5,347 |
| `verkko` | 2.2.1 | `quay.io/biocontainers/verkko:2.2.1--h45dadce_0` | Rautiainen 2023, PMID 36797492 | 68 | 64 |

## assembly_qc  (8)

| Tool | Version | Image | Citation | Total cites | Cites 2021–2025 |
|---|---|---|---|--:|--:|
| `bandage` | 0.8.1 | `staphb/bandage:0.8.1` | Wick 2015, PMID 26099265 | 2,188 | 1,623 |
| `busco` | 5.7.1 | `quay.io/biocontainers/busco:5.7.1--pyhdfd78af_0` | Manni 2021, PMID 34320675 | 11 | 10 |
| `checkm2` | 1.0.2 | `quay.io/biocontainers/checkm2:1.0.2--pyh7cba7a3_0` | Chklovski 2023, PMID 37501070 | 0 | 0 |
| `compleasm` | 0.2.6 | `quay.io/biocontainers/compleasm:0.2.6--pyh7cba7a3_0` | Huang & Li 2023, PMID 37862556 | 1 | 0 |
| `genovi` | 0.4.3 | `staphb/genovi:0.4.3` | Cumsille et al. 2023, PMID 37014908 | 80 | 71 |
| `gfastats` | 1.3.7 | `quay.io/biocontainers/gfastats:1.3.7--hdcf5f25_1` | Formenti 2022, PMID 35639517 | 182 | 164 |
| `merqury` | 1.3 | `quay.io/biocontainers/merqury:1.3--hdfd78af_1` | Rhie 2020, PMID 33025931 | 7 | 5 |
...
| `cafe5` | 5.1.0 | `quay.io/biocontainers/cafe:5.1.0--h5ca1c30_1` | Mendes et al. 2021, PMID 33325497 | 217 | 197 |
...
| `mafft` | 7.520 | `staphb/mafft:7.520` | Katoh & Standley 2013, PMID 23329690 | 31,029 | 19,244 |
...
| `skani` | 0.2.2 | `quay.io/biocontainers/skani:0.2.2--ha6fb395_2` | Shaw & Yu 2023, PMID 37419955 | 0 | 0 |

## deg  (3)

| Tool | Version | Image | Citation | Total cites | Cites 2021–2025 |
|---|---|---|---|--:|--:|
| `deseq2` | 1.44.0 | `quay.io/biocontainers/bioconductor-deseq2:1.50.2--r45ha27e39d_0` | Love 2014, PMID 25516281 | 72,129 | 52,514 |
...
| Tool | Version | Image | Citation | Total cites | Cites 2021–2025 |
|---|---|---|---|--:|--:|
| `clusterprofiler` | 4.12.0 | `quay.io/biocontainers/bioconductor-clusterprofiler:4.18.4--r45hdfd78af_0` | Wu 2021, PMID 34557778 | 9,446 | 8,821 |
| `enrichr` | 1.1.3 | `quay.io/biocontainers/gseapy:1.1.3--py311h5e00ca1_1` | Kuleshov 2016, PMID 27141961 | 8,486 | 6,128 |
...
| `methylpy` | 1.4.7 | `quay.io/biocontainers/methylpy:1.4.7--py39h0ae133c_0` | Schultz 2015, PMID 26039496 | 20 | 7 |
| `picard` | 3.2.0 | `quay.io/biocontainers/picard:3.2.0--hdfd78af_0` | Broad Institute, https://broadinstitute.github.io/picard/ | n/a | n/a |
| `tobias` | 0.16.1 | `quay.io/biocontainers/tobias:0.16.1--py312h1f1cfbb_1` | Bentsen et al. 2020, PMID 32024838 | 77 | 67 |

## func_annot  (5)

| Tool | Version | Image | Citation | Total cites | Cites 2021–2025 |
|---|---|---|---|--:|--:|
| `antismash` | 7.1.0 | `antismash/standalone:7.1.0` | Blin 2023, PMID 37140037 | 1,223 | 1,008 |
| `dbcan` | 4.1.4 | `quay.io/biocontainers/dbcan:4.1.4--pyhdfd78af_0` | Zhang 2018, PMID 29905870 | 416 | 296 |
...
| `gtdbtk` | 2.4.0 | `quay.io/biocontainers/gtdbtk:2.4.0--pyhdfd78af_1` | Chaumeil 2022, PMID 35906921 | 3 | 3 |
| `interproscan` | 5.67-99.0 | `quay.io/biocontainers/interproscan:5.59_91.0--hec16e2b_1` | Blum 2021, PMID 33220566 | 9 | 8 |

## metagenomics  (9)

| Tool | Version | Image | Citation | Total cites | Cites 2021–2025 |
|---|---|---|---|--:|--:|
| `bracken` | 2.9 | `quay.io/biocontainers/bracken:2.9--py39h9e0f934_1` | Lu et al. 2017, PMID 28655956 | 17 | 8 |
| `humann3` | 3.9 | `quay.io/biocontainers/humann:3.9--py312hdfd78af_0` | Beghini et al. 2021, PMID 33944776 | 1,713 | 1,553 |
| `kneaddata` | 0.12.0 | `quay.io/biocontainers/kneaddata:0.12.0--pyhdfd78af_0` | McIver et al. 2018, PMID 31616210 | 21 | 16 |
...
| `lefse` | 1.1.2 | `quay.io/biocontainers/lefse:1.1.2--pyhdfd78af_0` | Segata et al. 2011, PMID 21702898 | 11,274 | 7,333 |
| `maxbin2` | 2.2.7 | `quay.io/biocontainers/maxbin2:2.2.7--h503566f_8` | Wu 2016, PMID 26515820 | 2,058 | 1,582 |
| `metabat2` | 2.17 | `quay.io/biocontainers/metabat2:2.17--h6f16272_1` | Kang 2019, PMID 31336383 | 0 | 0 |
...
| `fragpipe` ⚠️ deprecated | 22.0 | `fcyu/fragpipe:22.0` | Yu et al. 2020, PMID 33338430 | 13 | 12 |
...
| `msconvert` | 3.0.24238 | `chambm/pwiz-skyline-i-agree-to-the-vendor-licenses:latest` | Chambers et al. 2012, PMID 22796944 | 70 | 22 |
...
| `percolator` | 3.06.1 | `quay.io/biocontainers/percolator:3.7.1--h3b5f4bd_2` | Kall et al. 2007, PMID 17944918 | 7 | 0 |
...
| `nanoplot` | 1.43.0 | `quay.io/biocontainers/nanoplot:1.43.0--pyhdfd78af_0` | De Coster 2023, PMID 36939539 | 14 | 11 |
...
| Tool | Version | Image | Citation | Total cites | Cites 2021–2025 |
|---|---|---|---|--:|--:|
| `earlgrey` | 4.5.0 | `quay.io/biocontainers/earlgrey:4.5.0--h4ac6f70_2` | Baril 2024, PMID 38162708 | 0 | 0 |
| `repeatmasker` | 4.1.7 | `dfam/tetools:1.89` | Smit 2015 (repeatmasker.org) | n/a | n/a |
| `repeatmodeler` | 2.0.5 | `dfam/tetools:1.89` | Flynn 2020, PMID 32591352 | 33 | 33 |
...
| `kallisto` | 0.51.1 | `quay.io/biocontainers/kallisto:0.51.1--h2b92561_2` | Bray 2016, PMID 27043002 | 7,846 | 5,295 |
| `rsem` | 1.3.3 | `quay.io/biocontainers/rsem:1.3.3--pl5321h077b44d_12` | Li & Dewey 2011, PMID 21816040 | 16,241 | 9,448 |
| `salmon` | 1.10.3 | `quay.io/biocontainers/salmon:1.10.3--h45fbf2d_5` | Patro 2017, PMID 28263959 | 9,676 | 7,496 |
| `star` | 2.7.11b | `quay.io/biocontainers/star:2.7.11b--h43eeafb_0` | Dobin 2013, PMID 23104886 | 41,939 | 29,063 |
...
| Tool | Version | Image | Citation | Total cites | Cites 2021–2025 |
|---|---|---|---|--:|--:|
| `bustools` | 0.43.2 | `quay.io/biocontainers/bustools:0.43.2--he1fd2f9_2` | Melsted 2019, PMID 31133686 | 12 | 8 |
| `cellranger` | 7.2.0 | `litd/docker-cellranger:v7.2.0` | Zheng et al. 2017, PMID 28091601 | 5,655 | 4,100 |
...
| `seurat` | 5.0.1 | `satijalab/seurat:5.0.0` | Hao et al. 2024, PMID 38066579 | 2 | 1 |
| `starsolo` | 2.7.11b | `quay.io/biocontainers/star:2.7.11b--h43eeafb_0` | Dobin et al. 2013, PMID 23104886 | 41,939 | 29,063 |
...
| `gatk4` | 4.6.1.0 | `quay.io/biocontainers/gatk4:4.6.1.0--py310hdfd78af_0` | McKenna 2010, PMID 20644199 | 16,781 | 7,991 |
